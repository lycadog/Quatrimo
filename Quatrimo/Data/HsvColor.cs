...
namespace Quatrimo.Data
{
    public class HsvColor
    {
        ...
        double h;
        public double H { get => h; set { h = value; recalculateColor(); } }

        double s;
        public double S { get => s; set { s = value; recalculateColor(); } }

        double v;
        public double V { get => v; set { v = value; recalculateColor(); } }
        ...
        public Color getAlteredColor(double hOffset = 0, double sOffset = 0, double vOffset = 0)
        {
